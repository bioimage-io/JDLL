...
public class BioimageIoModelPytorchProtected_old extends DLModelPytorchProtected {
	/**
	 ...
	 */
	protected BioimageIoModelPytorchProtected_old(String modelFile, String callable, String importModule, String weightsPath, 
