...
public class BioimageIoModelPytorch2 extends DLModelPytorch {
	/**
	...
	protected BioimageIoModelPytorch2(String modelFile, String callable, String weightsPath, 
	...
	public static BioimageIoModelPytorch2 create(ModelDescriptor descriptor) throws IOException {
		...
		return new BioimageIoModelPytorch2(modelFile, callable, weightsFile, kwargs, descriptor);
	}
	
	public static BioimageIoModelPytorch2 create(String modelPath) throws IOException {
	...
	public static <T extends NativeType<T> & RealType<T>> void main(String[] args) throws IOException, LoadEngineException, RunModelException, LoadModelException, InterruptedException, RuntimeException, MambaInstallException, ArchiveException, URISyntaxException {
		...
		BioimageIoModelPytorch2 model = create(mm);
