...
public class SharedMemoryArrayLiunxTem implements SharedMemoryArray {
     ...
     * 
     */
	private SharedMemoryArrayLiunxTem(String name) {
		this.memoryName = name;
	}
    ...
    /**
     * Retrive an existing Shared memory segment and wrap it into a {@link SharedMemoryArrayLiunxTem} 
     * @param memoryName
     * 	the name of the segment
     * @return the {@link SharedMemoryArrayLiunxTem}  pointing to the shared memory segment
     */
    protected static SharedMemoryArrayLiunxTem read(String memoryName) {
        ...
        SharedMemoryArrayLiunxTem shm = new SharedMemoryArrayLiunxTem(memoryName);
        shm.shmFd = shmFd;
