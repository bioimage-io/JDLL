...
public class TensorSpec_old {
    ...
    public static TensorSpec_old build(Map<String, Object> tensorSpecMap, boolean input) throws ModelSpecsException
    {
        TensorSpec_old tensor = new TensorSpec_old();
     ...
     * please use {@link #getOptimalTileSize(int[], String, TensorSpec_old)}
     * 
     * @param seqSize
     ...
     * @return the array with the patch of interest
     */
    public int[] getOptimalTileSize(int[] seqSize, String seqSizeAxes, TensorSpec_old affectedTensor) {
     ...
     * 
     * If the ouptut tensor size depends on the size of the current tensor, 
     * please use {@link #getOptimalTileSizeForTiling(int[], String, boolean, TensorSpec_old)}
     * 
     * @param seqSize
     * 	array containing the size of the sequence with the axes order defined
     * @param seqSizeAxes
     ...
     * @return the array with the patch of interest
     */
    public int[] getOptimalTileSizeForTiling(int[] seqSize, String seqSizeAxes, boolean applyTiling, TensorSpec_old affectedTensor) {
    ...
    private long calculateByteSizeOfAffectedOutput(String inputAxes, int[] inputSize, TensorSpec_old affectedOutput) {
