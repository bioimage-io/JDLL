...
public class TensorSpecV05 {
     ...
     * please use {@link #getOptimalTileSize(int[], String, TensorSpecV05)}
     * 
     * @param seqSize
     ...
     * @return the array with the patch of interest
     */
    public int[] getOptimalTileSize(int[] seqSize, String seqSizeAxes, TensorSpecV05 affectedTensor) {
     ...
     * 
     * If the ouptut tensor size depends on the size of the current tensor, 
     * please use {@link #getOptimalTileSizeForTiling(int[], String, boolean, TensorSpecV05)}
     * 
     * @param seqSize
     * 	array containing the size of the sequence with the axes order defined
     * @param seqSizeAxes
     ...
     * @return the array with the patch of interest
     */
    public int[] getOptimalTileSizeForTiling(int[] seqSize, String seqSizeAxes, boolean applyTiling, TensorSpecV05 affectedTensor) {
