...
public class TorchscriptEngine extends AbstractEngine {
	...
	private TorchscriptEngine(String version, boolean gpu, boolean isPython) {
		if (!isPython) 
	...
	public static TorchscriptEngine initialize(String version, boolean gpu, boolean isPython) {
		return new TorchscriptEngine(version, gpu, isPython);
	}
	...
	public static List<TorchscriptEngine> getInstalledVersions() {
		return null;
	}
