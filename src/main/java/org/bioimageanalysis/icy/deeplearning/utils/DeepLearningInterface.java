...
public interface DeepLearningInterface {
     ...
     *
     * @param inputTensors  list containing the input tensors
     * @param outputTensors list containing only the information about output tensors
     ...
     *
     * @param modelFolder String path to the folder where all the components of the model are stored
     * @param modelSource String path to the actual model file. In Pytorch is the path to a .pt file
