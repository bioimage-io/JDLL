...
/**
 * Class to copy RandomAccessibleIntervals into Java Arrays Check for possible
 * problems at:
...
public class RaiArrayUtils
{
	 ...
	 */
	public static < T extends Type< T > > Img< T > createCopyOfRaiInWantedDataType( RandomAccessibleInterval< T > rai,
			String type )
	{
			...
			Type type )
	{
		...
		else
		{
			throw new IllegalArgumentException(
					"The input corresponds to " + Util.getTypeFromInterval( rai ).getClass().toString()
							+ ", whose data type conversion is not supported yet." );
		}
	}

	/**
	 * MEthod that creates a copy of the {@link RandomAccessibleInterval} of
	 * FloatType in the wanted data type.
	 * 
	 * @param rai
	 ...
	 *            data type of the wanted tensor
	 */
	private static < T extends Type< T > > Img< T > createCopyOfFloatRaiInWantedDataType(
			RandomAccessibleInterval< FloatType > rai, Type type )
	{
		...
		{
			ArrayImg< ByteType, ByteArray > tensorBackend = ArrayImgs.bytes( RaiArrayUtils.convertFloatArrIntoByteArr( arr ),
					tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof IntType )
		{
			ArrayImg< IntType, IntArray > tensorBackend = ArrayImgs.ints( RaiArrayUtils.convertFloatArrIntoIntArr( arr ),
					tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof LongType )
		{
			ArrayImg< LongType, LongArray > tensorBackend = ArrayImgs.longs( RaiArrayUtils.convertFloatArrIntoLongArr( arr ),
					tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof DoubleType )
		{
			ArrayImg< DoubleType, DoubleArray > tensorBackend = ArrayImgs
					.doubles( RaiArrayUtils.convertFloatArrIntoDoubleArr( arr ), tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else
		{
	...
	/**
	 * MEthod that creates a copy of the {@link RandomAccessibleInterval} of
	 * IntType in the wanted data type.
	 * 
	 * @param rai
	 *            RandomAccessibleInterval where the copy is created from
	 * @param type
	 *            data type of the wanted tensor
	 */
	private static < T extends Type< T > > Img< T > createCopyOfIntRaiInWantedDataType( RandomAccessibleInterval< IntType > rai,
			Type type )
	{
		long[] tensorShape = rai.dimensionsAsLongArray();
		...
		{
			ArrayImg< DoubleType, DoubleArray > tensorBackend = ArrayImgs
					.doubles( RaiArrayUtils.convertIntArrIntoDoubleArr( arr ), tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof ByteType )
		{
			ArrayImg< ByteType, ByteArray > tensorBackend = ArrayImgs.bytes( RaiArrayUtils.convertIntArrIntoByteArr( arr ),
					tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof IntType )
		...
		{
			ArrayImg< LongType, LongArray > tensorBackend = ArrayImgs.longs( RaiArrayUtils.convertIntArrIntoLongArr( arr ),
					tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof FloatType )
		{
			ArrayImg< FloatType, FloatArray > tensorBackend = ArrayImgs
					.floats( RaiArrayUtils.convertIntArrIntoFloatArr( arr ), tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else
		{
			throw new IllegalArgumentException( "Data type conversion of IntType inputs to " + type.getClass().toString()
	...
	/**
	 * MEthod that creates a copy of the {@link RandomAccessibleInterval} of
	 * DoubleType in the wanted data type.
	 * 
	 * @param rai
	 *            RandomAccessibleInterval where the copy is created from
	 * @param type
	 *            data type of the wanted tensor
	 */
	private static < T extends Type< T > > Img< T > createCopyOfDoubleRaiInWantedDataType(
			RandomAccessibleInterval< DoubleType > rai, Type type )
	{
		long[] tensorShape = rai.dimensionsAsLongArray();
		double[] arr = RaiArrayUtils.doubleArray( ( RandomAccessibleInterval< DoubleType > ) rai );
		if ( type instanceof DoubleType )
		{
			ArrayImg< DoubleType, DoubleArray > tensorBackend = ArrayImgs.doubles( arr, tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof ByteType )
		{
			ArrayImg< ByteType, ByteArray > tensorBackend = ArrayImgs
					.bytes( RaiArrayUtils.convertDoubleArrIntoByteArr( arr ), tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof IntType )
		{
			ArrayImg< IntType, IntArray > tensorBackend = ArrayImgs.ints( RaiArrayUtils.convertDoubleArrIntoIntArr( arr ),
					tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof LongType )
		{
			ArrayImg< LongType, LongArray > tensorBackend = ArrayImgs
					.longs( RaiArrayUtils.convertDoubleArrIntoLongArr( arr ), tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof FloatType )
		{
			ArrayImg< FloatType, FloatArray > tensorBackend = ArrayImgs
					.floats( RaiArrayUtils.convertDoubleArrIntoFloatArr( arr ), tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else
		{
	...
	/**
	 * MEthod that creates a copy of the {@link RandomAccessibleInterval} of
	 * LongType in the wanted data type.
	 * 
	 * @param rai
	 *            RandomAccessibleInterval where the copy is created from
	 * @param type
	 *            data type of the wanted tensor
	 */
	private static < T extends Type< T > > Img< T > createCopyOfLongRaiInWantedDataType(
			RandomAccessibleInterval< LongType > rai, Type type )
	{
		...
		{
			ArrayImg< DoubleType, DoubleArray > tensorBackend = ArrayImgs
					.doubles( RaiArrayUtils.convertLongArrIntoDoubleArr( arr ), tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof ByteType )
		{
			ArrayImg< ByteType, ByteArray > tensorBackend = ArrayImgs.bytes( RaiArrayUtils.convertLongArrIntoByteArr( arr ),
					tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof IntType )
		{
			ArrayImg< IntType, IntArray > tensorBackend = ArrayImgs.ints( RaiArrayUtils.convertLongArrIntoIntArr( arr ),
					tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof LongType )
		{
			ArrayImg< LongType, LongArray > tensorBackend = ArrayImgs.longs( arr, tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof FloatType )
		{
			ArrayImg< FloatType, FloatArray > tensorBackend = ArrayImgs
					.floats( RaiArrayUtils.convertLongArrIntoFloatArr( arr ), tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else
		{
	...
	/**
	 * MEthod that creates a copy of the {@link RandomAccessibleInterval} of
	 * ByteType in the wanted data type.
	 * 
	 * @param rai
	 *            RandomAccessibleInterval where the copy is created from
	 * @param type
	 *            data type of the wanted tensor
	 */
	private static < T extends Type< T > > Img< T > createCopyOfByteRaiInWantedDataType(
			RandomAccessibleInterval< ByteType > rai, Type type )
	{
		...
		{
			ArrayImg< DoubleType, DoubleArray > tensorBackend = ArrayImgs
					.doubles( RaiArrayUtils.convertByteArrIntoDoubleArr( arr ), tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof ByteType )
		{
			ArrayImg< ByteType, ByteArray > tensorBackend = ArrayImgs.bytes( arr, tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof IntType )
		{
			ArrayImg< IntType, IntArray > tensorBackend = ArrayImgs.ints( RaiArrayUtils.convertByteArrIntoIntArr( arr ),
					tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof LongType )
		{
			ArrayImg< LongType, LongArray > tensorBackend = ArrayImgs.longs( RaiArrayUtils.convertByteArrIntoLongArr( arr ),
					tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else if ( type instanceof FloatType )
		{
			ArrayImg< FloatType, FloatArray > tensorBackend = ArrayImgs
					.floats( RaiArrayUtils.convertByteArrIntoFloatArr( arr ), tensorShape );
			return ( Img< T > ) tensorBackend;
		}
		else
		{
	...
	public static byte[] byteArray( final RandomAccessibleInterval< ByteType > image )
	{
		final byte[] array = extractByteArray( image );
		return array == null ? createByteArray( image ) : array;
	}

	public static double[] doubleArray( final RandomAccessibleInterval< DoubleType > image )
	{
		final double[] array = extractDoubleArray( image );
		return array == null ? createDoubleArray( image ) : array;
	}

	public static float[] floatArray( final RandomAccessibleInterval< FloatType > image )
	{
		final float[] array = extractFloatArray( image );
		return array == null ? createFloatArray( image ) : array;
	}

	public static int[] intArray( final RandomAccessibleInterval< IntType > image )
	{
		final int[] array = extractIntArray( image );
		return array == null ? createIntArray( image ) : array;
	}

	public static long[] longArray( final RandomAccessibleInterval< LongType > image )
	{
		final long[] array = extractLongArray( image );
		return array == null ? createLongArray( image ) : array;
	}

	private static byte[] createByteArray( final RandomAccessibleInterval< ByteType > image )
	{
	...
	private static double[] createDoubleArray( final RandomAccessibleInterval< DoubleType > image )
	{
		final long[] dims = Intervals.dimensionsAsLongArray( image );
	...
	private static float[] createFloatArray( final RandomAccessibleInterval< FloatType > image )
	{
		final long[] dims = Intervals.dimensionsAsLongArray( image );
	...
	private static int[] createIntArray( final RandomAccessibleInterval< IntType > image )
	{
		final long[] dims = Intervals.dimensionsAsLongArray( image );
	...
	private static long[] createLongArray( final RandomAccessibleInterval< LongType > image )
	{
		final long[] dims = Intervals.dimensionsAsLongArray( image );
	...
	private static byte[] extractByteArray( final RandomAccessibleInterval< ByteType > image )
	{
	...
	private static double[] extractDoubleArray( final RandomAccessibleInterval< DoubleType > image )
	{
		if ( !( image instanceof ArrayImg ) )
			return null;
		@SuppressWarnings( "unchecked" )
	...
	private static float[] extractFloatArray( final RandomAccessibleInterval< FloatType > image )
	{
		if ( !( image instanceof ArrayImg ) )
			return null;
		@SuppressWarnings( "unchecked" )
	...
	private static int[] extractIntArray( final RandomAccessibleInterval< IntType > image )
	{
		if ( !( image instanceof ArrayImg ) )
			return null;
		@SuppressWarnings( "unchecked" )
	...
	private static long[] extractLongArray( final RandomAccessibleInterval< LongType > image )
	{
		if ( !( image instanceof ArrayImg ) )
			return null;
		@SuppressWarnings( "unchecked" )
	...
	private static < T extends RealType< T > > void copy( final RandomAccessibleInterval< T > source,
