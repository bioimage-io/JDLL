...
public final class Tensor<T extends Type<T>> {
     ...
     *
     * @param tensorName name of the tensor as defined by the model
     * @param axes       String containing the axes order of the tensor. For example: "bcyx"
     * @param data       data structure similar to a Numpy array that contains all tensor numbers
     */
     ...
     *
     * @param lTensors list of tensors
     * @param name     name of the tensor of interest
     ...
     *
     * @param dimOrder String representation of the axes
     ...
     *
     * @param data the numbers of the tensor in a Numpy array like structure
     */
...
//    				+ "used as backend for the tensor.");
     ...
     *
     * @param tt the tensor whose backedn is going to be copied
     */
     ...
     *
     * @param shape the shape of the other tensor as a long arr
     ...
     *
     * @param isImage if the tensor is an image or not
     */
     ...
     *
     * @param data      the array backend of the tensor
     * @param axesOrder the axes order of the tensor
     */
