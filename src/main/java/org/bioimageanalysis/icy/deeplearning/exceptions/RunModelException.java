...
public class RunModelException extends Exception {
     ...
     *
     * @param msg the message of the original exception
     */
     ...
     * model
     *
     * @param nOutputTensors   number of tensors outputted by the model
     * @param nExpectedTensors number of tensors expected
     */
